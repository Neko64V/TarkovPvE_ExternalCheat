...
bool CExfil::GetEntity(uintptr_t& address)
{
	ptr = address;
...
bool CExfil::Update()
{
	...
	if (m_pVecLocation == Vector3(0.f, 0.f, 0.f))
		return false;
...
Vector3 CExfil::GetTransformPosition(uintptr_t& transform)
{
	__m128 result{};
